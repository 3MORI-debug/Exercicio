...
```bash
git clone https://github.com/3MORI-debug/Gridpics.git
```
...
Este projeto foi desenvolvido por [Felipe Rodrigues Tavares de Oliveira](https://github.com/seu_usuario).
